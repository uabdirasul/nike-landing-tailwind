...
const Footer = () => {
  return (
    <footer className="max-container text-white">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Get shoes ready for your next adventure
          </p>
      ...
      <div className="flex justify-between text-white-400 mt-24 nax-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-center inline-center gap-2 font-montserrat cursor-pointer">
          <p className="text-base leading-7 font-montserrat">
            © 2024 Nike Land. All rights reserved.
          </p>
        </div>
